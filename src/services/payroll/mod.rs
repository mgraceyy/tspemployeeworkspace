...
pub use compute::{
    base_pay_cents_for_period, employed_days_in_period, gross_pay_cents, hourly_rate_cents,
    inclusive_calendar_days, lwop_deduction_cents, no_show_deduction_cents, ot_pay_cents,
    period_salary_factor, prorated_period_amount_cents, round_div, EmploymentSpan, GrossPayInput,
    MONTHLY_WORKING_DAYS, STANDARD_DAILY_MINUTES,
};
pub use deductions::{
...
pub use deductions_auto::{
    ...
    recalculate_government_deductions_for_run, recalculate_lwop_deductions_for_run,
    FinalizePreflight,
};
pub use export::{
